...
#    parser.add("--id_rep", default=None, type=str)
    ...
    parser.add("--rec_vel_weight", default=0.0, type=float)
    parser.add("--rec_acc_weight", default=0.0, type=float)
    parser.add('--rec_ver_vel_weight', default=0.0, type=float)
    parser.add('--rec_ver_acc_weight', default=0.0, type=float)
    parser.add("--comm_weight", default=0.0, type=float)
